...
import com.fernandocejas.android10.sample.presentation.binding.AutoLoadImageView.ImageUrlViewBinding;
...
public class AndroidApplication extends Application {
    ...
    BinderFactory reusableBinderFactory;
...
//                .add(new DynamicViewBinding().forView(AutoLoadImageView.class).oneWayProperties("imageUrl"))
                .add(new ImageUrlViewBinding().extend(AutoLoadImageView.class))
                .build();
